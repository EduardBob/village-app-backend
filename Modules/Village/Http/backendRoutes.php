...
$router->group(['prefix' => '/village'], function (Router $router) {
    ...
    $router->resource('villages', 'VillageController', [
      'except' => ['show'],
      'names'  => [
    ...
    $router->group(['prefix' => 'buildings'], function (Router $router) {
        $router->get('get-choices-by-village/{byVillageId}',
          ['uses' => 'BuildingController@getChoicesByVillage', 'as' => 'admin.village.building.get_choices_by_village']);
        $router->get('get-choices-by-village/{byVillageId}/{selectedBuildingId}',
          ['uses' => 'BuildingController@getChoicesByVillage', 'as' => 'admin.village.building.get_choices_by_village']);
    });
    ...
    $router->resource('basearticles', 'BaseArticleController', [
      'names' => [
    ...
    $router->resource('articlecategories', 'ArticleCategoryController', [
      'except' => ['show'],
      'names'  => [
    ...
    $router->resource('margins', 'MarginController', [
      'except' => ['show'],
      'names'  => [
    ...
    $router->resource('baseproducts', 'BaseProductController', [
      'names' => [
    ...
    $router->group(['prefix' => 'products'], function (Router $router) {
        $router->get('get-choices-by-village/{byVillageId}', ['uses' => 'ProductController@getChoicesByVillage', 'as' => 'admin.village.product.get_choices_by_village']);
    });
    ...
    $router->resource('productcategories', 'ProductCategoryController', [
      'except' => ['show'],
      'names'  => [
    ...
    $router->group(['prefix' => 'productcategories'], function (Router $router) {
        $router->get('get-choices-by-village/{byVillageId}',
          ['uses' => 'ProductCategoryController@getChoicesByVillage', 'as' => 'admin.village.productcategory.get_choices_by_village']);
        $router->get('get-choices-by-village/{byVillageId}/{selectedId}',
          ['uses' => 'ProductCategoryController@getChoicesByVillage', 'as' => 'admin.village.productcategory.get_choices_by_village']);
    });
    $router->bind('productorders', function ($id) {
        return app('Modules\Village\Repositories\ProductOrderRepository')->find($id);
    });
    $router->resource('productorders', 'ProductOrderController', [
      'names' => [
...
//        $router->put('{id}/done', 	 ['uses' => 'ProductOrderController@setStatusDone', 'as' => 'admin.village.productorder.set_status_done']);
        ...
        $router->put('{id}/status-running',
          ['uses' => 'ProductOrderController@setStatusRunning', 'as' => 'admin.village.productorder.set_status_running']);
        ...
        $router->put('{id}/payment-and-status-done',
          ['uses' => 'ProductOrderController@setPaymentAndStatusDone', 'as' => 'admin.village.productorder.set_payment_and_status_done']);
    });
    $router->resource('productorderchanges', 'ProductOrderChangeController', [
    ...
    $router->resource('baseservices', 'BaseServiceController', [
      'names' => [
    ...
    $router->group(['prefix' => 'services'], function (Router $router) {
        $router->get('get-choices-by-village/{byVillageId}',
          ['uses' => 'ServiceController@getChoicesByVillage', 'as' => 'admin.village.service.get_choices_by_village']);
    });
    ...
    $router->resource('servicecategories', 'ServiceCategoryController', [
      'except' => ['show'],
      'names'  => [
    ...
    $router->group(['prefix' => 'servicecategories'], function (Router $router) {
        $router->get('get-choices-by-village/{byVillageId}',
          ['uses' => 'ServiceCategoryController@getChoicesByVillage', 'as' => 'admin.village.servicecategory.get_choices_by_village']);
        $router->get('get-choices-by-village/{byVillageId}/{selectedId}',
          ['uses' => 'ServiceCategoryController@getChoicesByVillage', 'as' => 'admin.village.servicecategory.get_choices_by_village']);
    });
    ...
    $router->resource('serviceorders', 'ServiceOrderController', [
      'names' => [
    ...
    $router->resource('serviceorderssc', 'ServiceOrderScController', [
      'except' => ['show', 'create', 'store', 'edit', 'update', 'destroy'],
      'names'  => [
    ...
    $router->resource('basesurveys', 'BaseSurveyController', [
      'names' => [
    ...
    $router->resource('surveys', 'SurveyController', [
      'except' => ['show'],
      'names'  => [
    ...
    $router->resource('surveyvotes', 'SurveyVoteController', [
      'except' => ['show'],
      'names'  => [

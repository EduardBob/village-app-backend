...
return [
  ...
  'button'     => [
    'create' => 'Добавить новость',
    'updateAndPush' => 'Сохранить и отправить пуш нотификацию',
  ],
  'table'      => [
    'id'           => 'ID',
    'title'        => 'Название',
  ...
  'form'       => [
    'media'                    => 'Изображение',
    'is_important_description' => 'При сохранении будет разослана клиентам<br>(не работает в новостях с отложенной датой публикации)',
    'users'                    => 'Пользователи',
    'all_roles'                => 'Все роли',

...
return [
  ...
  'table'      => [
    ...
    'open_door_link'  => 'Ссылка, по которой может быть вызвано открывание калитки на КПП',
    'open_barrier_link'  => 'Ссылка, по которой может быть вызвано открывание шлагбаума на КПП',
  ],
  'services'   => [

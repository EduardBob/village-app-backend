    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                {!! Form::text('title', Input::old('title'), ['class' => 'form-control', 'placeholder' => trans('village::products.table.title')]) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                ...
                {!! Form::text('price', Input::old('price'), ['class' => 'form-control', 'placeholder' => trans('village::products.table.price')]) !!}

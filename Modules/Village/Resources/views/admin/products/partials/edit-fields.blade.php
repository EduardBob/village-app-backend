    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                ...
                {!! Form::select('category', (new Modules\Village\Entities\ProductCategory)->lists('title', 'id'),
                @$model->category->id?:Input::old('category'), ['class' => 'form-control', 'placeholder' => $admin->trans('form.category.placeholder')]) !!}

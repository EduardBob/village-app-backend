    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group{{ $errors->has('service') ? ' has-error' : '' }}">
                ...
                $model->service->id, ['class' => 'form-control', 'placeholder' => $admin->trans('form.service.placeholder')]) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group{{ $errors->has('profile') ? ' has-error' : '' }}">
                ...
                $model->profile->user->id, ['class' => 'form-control', 'placeholder' => $admin->trans('form.profile.placeholder')]) !!}
